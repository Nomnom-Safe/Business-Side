...
// @access  Protected
router.post('/get-user-list', asyncHandler(async (req, res) => {
...
router.post('/change-admin-status', asyncHandler(async (req, res) => {
...
// @access  Public (no auth yet)
router.post('/remove-user-access', asyncHandler(async (req, res) => {
...
// @access  Public (no auth yet)
router.post('/add-user-access', asyncHandler(async (req, res) => {
	const business_id = await getBusinessId(req.user.email);
